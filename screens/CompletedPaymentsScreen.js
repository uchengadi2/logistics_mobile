...
import PaymentCompleteGridTile from "../components/PaymentCompleteGridTile";

function CompletedPaymentsScreen({ navigation }) {
  ...
  function renderPaymentItem(itemData) {
    function pressHandler() {
      navigation.navigate("CompletePaymentOverviewScreen", {
        id: itemData.item.id,
...
export default CompletedPaymentsScreen;
